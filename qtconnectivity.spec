...
%patch -P 1 -p1
pushd ..
cp -a qtconnectivity-everywhere-src-5.15.2 buildavx2
popd
...
%install
export SOURCE_DATE_EPOCH=1687229556
rm -rf %{buildroot}
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libQt5Bluetooth.so.5.15.2
/V3/usr/lib64/libQt5Nfc.so.5.15.2
